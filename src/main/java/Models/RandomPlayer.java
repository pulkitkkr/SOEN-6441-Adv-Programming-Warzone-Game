...
public class RandomPlayer extends PlayerBehaviorStrategy {
	...
	public String createCardOrder(Player p_player, GameState p_gameState, String p_cardName) {
		...
		// Country l_randomEnemyNeighbor =
		// p_gameState.getD_map().getCountry(randomEnemyNeighbor(p_player,
		// l_randomOwnCountry).get(l_random.nextInt(randomEnemyNeighbor(p_player,
		// l_randomOwnCountry).size())));
	...
	/**
	 * This method generate random player.
	 * 
