...
public class RandomPlayer extends PlayerBehaviorStrategy {
	...
	public String createAdvanceOrder(Player p_player, GameState p_gameState) {
		...
		Country l_randomNeighbor = p_gameState.getD_map().getCountry(l_randomOwnCountry.getD_adjacentCountryIds()
	...
	/**
	 * This method return List of Ids of random enemy neighbors.
	 * 
